...
const REASON_KEYS: Record<string, LocaleKey> = {
  ...
  [TURNREWIND_REASON_UNSAFE_WORKSPACE]: 'unsafeWorkspaceReason',
  [TURNREWIND_REASON_TOO_MANY_FILES]: 'tooManyFilesReason',
  [TURNREWIND_REASON_SNAPSHOT_TOO_LARGE]: 'snapshotTooLargeReason',
  [TURNREWIND_REASON_TOO_MANY_OVERSIZED]: 'tooManyOversizedReason',
  [TURNREWIND_REASON_ALREADY_UNDONE]: 'alreadyUndoneReason',
  [TURNREWIND_REASON_CONFLICT]: 'conflictReason',
  [TURNREWIND_REASON_NON_EMPTY_DIR]: 'nonEmptyDirReason',
}
