...
export const REASON_UNSAFE_WORKSPACE = TURNREWIND_REASON_UNSAFE_WORKSPACE

/** 快照文件数超限。 */
export const REASON_TOO_MANY_FILES = TURNREWIND_REASON_TOO_MANY_FILES

/** 快照聚合字节超限。 */
export const REASON_SNAPSHOT_TOO_LARGE = TURNREWIND_REASON_SNAPSHOT_TOO_LARGE

/** 超限文件太多，无法逐个排除（该轮不提供撤销）。 */
export const REASON_TOO_MANY_OVERSIZED = TURNREWIND_REASON_TOO_MANY_OVERSIZED
...
export const REASON_ALREADY_UNDONE = TURNREWIND_REASON_ALREADY_UNDONE

/** 撤销被并发修改拦截。 */
export const REASON_CONFLICT = TURNREWIND_REASON_CONFLICT
...
export const REASON_NON_EMPTY_DIR = TURNREWIND_REASON_NON_EMPTY_DIR
