 ...
 */
export declare function readPersistedSession(persistence: SidebarSessionPersistenceService, sessionId: string): Promise<PersistedSession>;
/**
 ...
 */
export declare function readPersistedSessionOf(ctx: Context, sessionId: string): Promise<PersistedSession | undefined>;
