...
pub fn handler() -> impl Fn(Invoke<Wry>) -> bool + Send + Sync + 'static {
    tauri::generate_handler![
        ...
        crate::bridge::get_skip_user_plugins,
        crate::bridge::set_skip_user_plugins,
        ...
        crate::bridge::pick_local_plugin_directory,
        crate::bridge::install_local_plugin,
        ...
        crate::bridge::open_webview_devtools,
